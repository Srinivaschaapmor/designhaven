...
const BestsellersCarousel = () => {
  ...
  useEffect(() => {
    if (itemsRef.current.length > 0) {
      ...
      const totalWidth =
        (itemWidthRef.current + marginRight) * totalItemsRef.current; // Total width of all items
      ...
      <div id="bestsellers-carousel" className="bestsellers-carousel">
        <div className="bestsellers-carousel-track" ref={carouselTrackRef}>
          {[
            ...
            {
              src: "src/assets/Our-Best-Sellers/test.jpeg",
              alt: "Photo 1",
              caption: "ACCESSORIES",
            },
            {
            ...
            {
              src: "src/assets/Our-Best-Sellers/Closet3.jpeg",
              alt: "Photo 3",
            ...
            <a
              key={index}
              className="bestsellers-carousel-item"
        ...
        <div className="bestsellers-carousel-nav">
          <button
            className="bestsellers-carousel-button prev"
          ...
          <button
            className="bestsellers-carousel-button next"
